...
if (!defined('CONTACT_EMAIL')) {
    ...
    define('DEFAULT_LANGUAGE', 4); // English
    ...
    define('NINJA_WEB_URL', 'https://www.cazus-dev.com');
    define('NINJA_APP_URL', 'https://cazus-dev.com');
    define('NINJA_VERSION', '1');
    define('NINJA_DATE', '2000-01-01');

    define('NINJA_FROM_EMAIL', 'contact@cazus-dev.com');
