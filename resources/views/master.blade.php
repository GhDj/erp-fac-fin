...
<head>
    <title>{{ isset($title) ? ($title . ' | Cazus Workflow') : ('Cazus Workflow | ' . trans('texts.app_title')) }}</title> 
    <meta name="description" content="{{ isset($description) ? $description : trans('texts.app_description') }}" />


    <meta charset="utf-8">
    <meta property="og:site_name" content="Cazus Workflow" />
    <meta property="og:url" content="{{ SITE_URL }}" />
    <meta property="og:title" content="Cazus Workflow" />
